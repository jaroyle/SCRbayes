...
LMD[1:length(LMD)]<- llvector.new-llvector
if(runif(1)< exp(sum( LMD%*%ones))){
 loglam0<-loglam0c
 lam0<-exp(loglam0)
...
###
###
### Does this need done at the end?
###
###
###
if(Msexsigma==0)
